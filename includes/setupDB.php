<?php
    ...
    */
    ...
    // Creating a test user admin, this is because our books table requires a username,
    // only people with a given username can access their books.
